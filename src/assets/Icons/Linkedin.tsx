...
const LinkedinIcon = forwardRef<LinkedinIconHandle, LinkedinIconProps>(
  ({ onMouseEnter, onMouseLeave, className, size = 28, ...props }, ref) => {
    ...
    return (
      <div
        className="flex cursor-pointer select-none items-center justify-center rounded-md p-2 text-black transition-colors duration-200 hover:!opacity-100 group-hover:opacity-50 dark:text-white"
